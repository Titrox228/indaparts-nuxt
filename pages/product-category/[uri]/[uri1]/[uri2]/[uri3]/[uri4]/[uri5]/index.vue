...
const uri = route.params.uri5
const product_id = `/product-category/${route.params.uri}/${route.params.uri1}/${route.params.uri2}/${route.params.uri3}/${route.params.uri4}/${route.params.uri5}`
